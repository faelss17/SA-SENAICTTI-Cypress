...
Rafael — SENAI Minas Gerais
Projeto avaliativo da UC: Testes Automatizados com Cypress

✔ Situação de Aprendizagem atendida

☑ Planejamento e execução de testes
☑ Testes automatizados E2E com Cypress
☑ Testes de interface web (elementos interativos e visualização)
☑ Documentação clara das rotinas de testes
☑ Entrega e apresentação em grupo
